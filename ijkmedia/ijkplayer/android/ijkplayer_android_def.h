...
enum media_error_type {
    ...
    MEDIA_ERROR_IJK_PLAYER_STREAM_OPEN                  = -10010,

    MEDIA_ERROR_IJK_PLAYER_FRAME_QUEUE_INIT_VIDEO       = -10011,
    MEDIA_ERROR_IJK_PLAYER_FRAME_QUEUE_INIT_SUBTITLE    = -10012,
    MEDIA_ERROR_IJK_PLAYER_FRAME_QUEUE_INIT_AUDIO       = -10013,
    MEDIA_ERROR_IJK_PLAYER_PACKET_QUEUE_INIT_ALL        = -10014,
    MEDIA_ERROR_IJK_PLAYER_CONTINUE_READ_THREAD         = -10015,
    MEDIA_ERROR_IJK_PLAYER_VIDEO_REFRESH_TID            = -10016,
    MEDIA_ERROR_IJK_PLAYER_READ_TID                     = -10017,
    MEDIA_ERROR_IJK_PLAYER_FILE_NAME                    = -10018,

    MEDIA_ERROR_IJK_PLAYER_WAIT_MUTEX                   = -10021,
    MEDIA_ERROR_IJK_PLAYER_AVFORMAT_ALLOC_CONTEXT       = -10022,
    MEDIA_ERROR_IJK_PLAYER_AVFORMAT_OPEN_INPUT          = -10023,
    MEDIA_ERROR_IJK_PLAYER_AVFORMAT_FIND_STREAM_INFO    = -10024,
    MEDIA_ERROR_IJK_PLAYER_NO_VIDEO_OR_AUDIO_STREAM     = -10025,
    MEDIA_ERROR_IJK_PLAYER_AV_DICT_GET                  = -10026,
    MEDIA_ERROR_IJK_PLAYER_AV_COPY_PACKET               = -10027,
    MEDIA_ERROR_IJK_PLAYER_AUTO_EXIT                    = -10028,

    /* stream_component_open */ /* 直接影响 MEDIA_ERROR_IJK_PLAYER_NO_VIDEO_OR_AUDIO_STREAM(-10025) */
    MEDIA_ERROR_IJK_PLAYER_AVCODEC_NOT_FIND             = -10031,
    MEDIA_ERROR_IJK_PLAYER_AVCODEC_OPEN                 = -10032,
    MEDIA_ERROR_IJK_PLAYER_AUDIO_OPEN                   = -10033,
    //MEDIA_ERROR_IJK_PLAYER_AUDIO_DECODER_START          = -10034,
    MEDIA_ERROR_IJK_PLAYER_OPEN_VIDEO_DECODER           = -10035,
    //MEDIA_ERROR_IJK_PLAYER_VIDEO_DECODER_START          = -10036,
    MEDIA_ERROR_IJK_PLAYER_AVCODEC_PARAMETERS_TO_CONTEXT= -10037,
    MEDIA_ERROR_IJK_PLAYER_CONFIGURE_AUDIO_FILTERS      = -10038,
    MEDIA_ERROR_IJK_PLAYER_AVCODEC_ALLOC_CONTEXT3       = -10039,
    MEDIA_ERROR_IJK_PLAYER_STREAM_INDEX                 = -10040,
